...
This version of rfm is a segnificant upgrade to rfm in a few ways. First and most important (to me anyway) is it allows for the use of secure connections and certificate files.
...
switched to nokogiri which is a huge speed improvement over REXML which is used in rfm 1.0.0. As of now this is also the only rfm gem in active development.

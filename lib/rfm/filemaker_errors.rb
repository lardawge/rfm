module Rfm
  ...
  # FileMakerError is the base for the error hierarchy representing errors returned by Filemaker.
  # 
  ...
  module FilemakerError
    ...
    def build_message(klass, code, message=nil) #:nodoc:
      ...
      "#{klass.to_s.gsub(/Rfm::FilemakerError::/, '')} occurred#{msg}"
    end
